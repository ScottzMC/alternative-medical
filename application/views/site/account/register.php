...
<head>
    ...
    <meta charset="UTF-8">
    <!-- Title -->
    <title>Advanced Alternative Medical Solution || Create an Account</title>
                    ...
                    <div class="full-width-contents">
                        <div class="entry-content">
                            <div class="woocommerce">
                                <div class="woocommerce-info">Login here <a href="<?php echo site_url('account/login'); ?>">Click here to login</a></div>
                                <form class="checkout woocommerce-checkout" action="<?php echo base_url('account/register'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-1">
                                            <div class="woocommerce-billing-fields">
                                                ...
                                                <p class="form-row form-row form-row-first validate-required" id="">
                                                  ...
                                                  <input type="password" class="input-text " name="cpassword" placeholder="Confirm Password">
                                  ...
                                  <div class="form-row place-order">
                                    <input type="submit" class="button alt" name="registerBtn" value="Register">
                                  </div>
                              </form>
