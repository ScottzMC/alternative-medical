...
<html lang="en">
	<head>
	  ...
	  <title>Add Product Item || Admin AAMS</title>
	</head>
  ...
  <body>
  		...
  		<div class="page-wrapper">
              <div class="container-fluid">
                ...
                <li><a href="<?php echo site_url('admin/product/add_product')?>">Add Product</a></li>
  					  </ol>
  					</div>
  					<!-- /Breadcrumb -->
  				</div>
					...
					<div class="row">
                        ...
                        <div class="row">
                              ...
                              <span class="text-danger"><?php echo form_error('description'); ?></span>
												...
												<h6 class="txt-dark capitalize-font"><i class="icon-picture mr-10"></i>Upload Product Image</h6>
												<hr>
												<div class="row">
													<div class="col-lg-12">
                            <input type="file" name="userCover[]" class="filestyle" data-buttonname="btn-primary">
														</div>
													</div>
												</div>
												<div class="seprator-block"></div>
